...
function AboutUs() {
  return (
    < div>
        ...
        viewport={{ once: true }}>
        <Card Title='About walbrue'
          Para='Welcome to walbrue,where purity  meets excellence in every drop. As a dedicated packaged drinking water company based in Goa. As the emerging demands supply water, walbrue takes immense pride in delivering pristine and refreshing hydration to our local community. Hence we are committed to provide and maintain the highest standards of quality, considering this our water undergoes rigorous purification processes to ensure unmatched purity and cater to the needs of the people, by considering the importance of health. With a focus on backward integration, we are committed to establishing our own production facilities, that makes us a unique beverage company within our state.'
        /> 
        
        <Card Title='Why Choose Us?'
          Para='As water is the most essential elixir of life, it is difficult to live without it. In the constant demand by the families in search of healthy  water that provides correct minerals and nutrients, walbrue is the right place where your needs would be met. Our water is palatable and delectable in nature. Our unwavering commitment to purity ensures the highest quality standards. walbrue is ardent in delivering freshness and reliability in every sip. We are dedicated towards the sustainable management of water resources within the natural ecosystem that is essential for preserving the harmony of nature, safeguarding the environment and promoting the health of society.'
          About={false}
